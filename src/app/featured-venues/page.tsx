...
export const metadata: Metadata = {
  ...
  description:
    ...
    'Venue production guide for corporate planners — hotel ballrooms, convention centers, resorts, and unique spaces. Site visit checklists, house AV, union labor, and what to send your production vendor.',
  openGraph: {
