    ...
    <div className="space-y-8">
      <div className="bg-white/5 border border-white/10 rounded-xl p-8">
        ...
        <p className="text-gray-400 text-sm mb-6">
          ...
          Google Workspace) with the inquiry details. Only addresses ending in{' '}
        ...
        <p className="text-gray-500 text-xs mt-2">
          ...
          these settings. Outbound mail requires <code className="text-gray-400">SMTP_USER</code>,{' '}
          <code className="text-gray-400">SMTP_PASS</code>, and for DreamHost{' '}
          <code className="text-gray-400">SMTP_HOST=smtp.dreamhost.com</code> (see deploy docs).
        </p>
      </div>
